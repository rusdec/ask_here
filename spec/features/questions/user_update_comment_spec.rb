...
feature 'User update comment', %q{
  ...
  I can update questions comment
  ...
  given!(:comment) { create(:comment, user: comment_author, commentable: question) }
  ...
  context 'multiple sessions' do
    scenario 'comment update on another user\'s page under question', js: true do
